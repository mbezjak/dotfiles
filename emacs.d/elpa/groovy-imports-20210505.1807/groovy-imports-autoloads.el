;;; groovy-imports-autoloads.el --- automatically extracted autoloads (do not edit)   -*- lexical-binding: t -*-
...
Return a list of all fully-qualified packages in the current Groovy-mode buffer." t)
...
(provide 'groovy-imports-autoloads)
